...
kafka-topics.sh --delete --bootstrap-server localhost:29092 --topic crimes-output || true
kafka-topics.sh --delete --bootstrap-server localhost:29092 --topic iucr-output || true
...
kafka-topics.sh --create --topic crimes-output --bootstrap-server localhost:29092 --replication-factor 1 --partitions 1
